<%@ Page Title="" Language="C#" MasterPageFile="~/View/Bootstrap.Master" AutoEventWireup="true" CodeBehind="SiparisEkle.aspx.cs" Inherits="SiparisListeleme.SiparisEkle" %>
    ...
    <div class="container">
       ...
       <tr>
            ...
            <tr>
             ...
             <tr>
                 <td>Daha fazla sipariş eklemek için işaretleyiniz</td>
                 <td>
                     <asp:CheckBox ID="chkSurekliGiris" runat="server" /></td>
             </tr>
